...
**3. 翻案腔**：先给读者立一个他并没有的误解，再推翻它抬价。禁的是这个动作，不是字面："不是…而是…"、"你以为…其实…"、"看似…实则…"、"X 本身没有价值，真正有用的是 Y"、"X 已经不是瓶颈，Y 才是" 都是同一副骨架换了外衣。直接从正面下判断，依据放在旁边。
...
- 一段里句子长度都差不多，是最好量的模型腔。挑一句压到十字以内，或放开一句超过三十字
- 连词删掉一半再读，中文小句靠语序和事理就能接上，读不断的地方不用补回来
- 一句话里三个以上的"的"就重写：先让做事的人和动作出现，原因、时间、条件接到后面
